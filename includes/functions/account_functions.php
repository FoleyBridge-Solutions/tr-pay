...
function createAccountType(
    ...
    //Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Account Type', log_action = 'Create', log_description = '$name', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id");
}
function editAccountType(
    ...
    //Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Account Type', log_action = 'Edit', log_description = '$name', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id");
}
...
function archiveAccountType(
    ...
    //Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Account Type', log_action = 'Archive', log_description = '$account_type_id', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id");
}
function unarchiveAccountType(
    ...
    //Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Account Type', log_action = 'Unarchive', log_description = '$account_type_id', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id");
}
function createAccount(
    ...
    //Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Account', log_action = 'Create', log_description = '$name', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id");
...
function editAccount(
    ...
    //Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Account', log_action = 'Modify', log_description = '$name', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id");
}
...
function archiveAccount(
    ...
    //logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Account', log_action = 'Archive', log_description = '$account_id', log_ip = '$ip', log_user_agent = '$user_agent'");
}
function unarchiveAccount(
    ...
    //Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Account', log_action = 'Unarchive', log_description = '$account_id', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id");
}
function deleteAccount(
    ...
    //Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Account', log_action = 'Delete', log_description = '$account_id', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id");
}