...
if (isset($_POST['move_inventory'])) {
    ...
    // Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Inventory', log_action = 'Move', log_description = '$name moved $inventory_quantity items of product $inventory_product_id from location $inventory_location_id to location $inventory_new_location_id', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id");
...
if (isset($_POST['add_inventory_locations'])) {
    ...
    // Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Inventory', log_action = 'Create', log_description = '$name created inventory location $inventory_location_name', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id");
...
if (isset($_POST['edit_inventory_locations'])) {
    ...
    // Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Inventory', log_action = 'Edit', log_description = '$name edited inventory location $inventory_location_name', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id");
...
if (isset($_GET['archive_inventory_location'])) {
    ...
    // Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Inventory', log_action = 'Archive', log_description = '$name archived inventory location $inventory_location_id', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id");
