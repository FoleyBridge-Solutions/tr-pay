...
if (isset($_POST['add_calendar'])) {
    ...
    //Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Calendar', log_action = 'Create', log_description = '$name created calendar $name', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id, log_entity_id = $calendar_id");
...
if (isset($_POST['add_event'])) {
    ...
    require_once '/var/www/itflow-ng/includes/post/models/event_model.php';
    ...
    if ($email_event == 1) {
        ...
        if ($mail === true) {
            mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Calendar Event', log_action = 'Email', log_description = '$name emailed event $title to $contact_name from client $client_name', log_ip = '$ip', log_user_agent = '$user_agent', log_client_id = $client, log_user_id = $user_id, log_entity_id = $event_id");
        } else {
    ...
    //Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Calendar Event', log_action = 'Create', log_description = '$name created a calendar event titled $title in calendar $calendar_name', log_ip = '$ip', log_client_id = $client, log_user_agent = '$user_agent', log_user_id = $user_id, log_entity_id = $event_id");
...
if (isset($_POST['edit_event'])) {
    ...
    if ($email_event == 1) {
        ...
        // Logging for email (success/fail)
        if ($mail === true) {
            mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Calendar_Event', log_action = 'Email', log_description = '$name Emailed modified event $title to $client_name email $client_email', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id");
        } else {
            mysqli_query($mysqli,"INSERT INTO notifications SET notification_type = 'Mail', notification = 'Failed to send email to $contact_email'");
            mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Mail', log_action = 'Error', log_description = 'Failed to send email to $contact_email regarding $subject. $mail', log_ip = '$ip', log_user_agent = '$user_agent', log_user_id = $user_id");
        }
    ...
    //Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Calendar Event', log_action = 'Modify', log_description = '$name modified calendar event $title', log_ip = '$ip', log_user_agent = '$user_agent', log_client_id = $client, log_user_id = $user_id, log_entity_id = $event_id");
...
if (isset($_GET['delete_event'])) {
    ...
    //Logging
    mysqli_query($mysqli,"INSERT INTO logs SET log_type = 'Calendar Event', log_action = 'Delete', log_description = '$name deleted calendar event titled $event_title', log_ip = '$ip', log_user_agent = '$user_agent', log_client_id = $client_id, log_user_id = $user_id");
