...
if (isset($_POST['add_project'])) {
    ...
    if($project_template_id) {
        ...
        while ($row = mysqli_fetch_array($sql_ticket_templates)) {
            ...
            mysqli_query($mysqli, "INSERT INTO tickets SET ticket_prefix = '$config_ticket_prefix', ticket_number = $ticket_number, ticket_subject = '$ticket_template_subject', ticket_details = '$ticket_template_details', ticket_priority = 'Low', ticket_status = 1, ticket_created_by = $user_id, ticket_client_id = $client_id, ticket_project_id = $project_id");
    ...
    // Logging
    mysqli_query($mysqli, "INSERT INTO logs SET log_type = 'Project', log_action = 'Create', log_description = '$name created project $project_name', log_ip = '$ip', log_user_agent = '$user_agent', log_client_id = $client_id, log_user_id = $user_id, log_entity_id = $project_id");
...
if (isset($_GET['close_project'])) {
    ...
    // Logging
    mysqli_query($mysqli, "INSERT INTO logs SET log_type = 'Project', log_action = 'Close', log_description = '$name closed project $project_name', log_ip = '$ip', log_user_agent = '$user_agent', log_client_id = $client_id, log_user_id = $user_id, log_entity_id = $project_id");
...
if (isset($_GET['delete_project'])) {
    ...
    // Logging
    mysqli_query($mysqli, "INSERT INTO logs SET log_type = 'Projects', log_action = 'Delete', log_description = '$name deleted project $project_name', log_ip = '$ip', log_user_agent = '$user_agent', log_client_id = $client_id, log_user_id = $user_id, log_entity_id = $project_id");
...
if (isset($_POST['add_project_ticket'])) {
    ...
    // Logging
    mysqli_query($mysqli, "INSERT INTO logs SET log_type = 'Project', log_action = 'Edit', log_description = '$name added a ticket $ticket_subject to project $project_name', log_ip = '$ip', log_user_agent = '$user_agent', log_client_id = $client_id, log_user_id = $user_id, log_entity_id = $project_id");
