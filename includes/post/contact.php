...
if (isset($_POST['add_contact'])) {
    ...
    require_once '/var/www/itflow-ng/includes/post/models/contact_model.php';
...
if (isset($_POST['edit_contact'])) {
    ...
    if (!file_exists("/var/www/itflow-ng/uploads/clients/$client_id")) {
        mkdir("/var/www/itflow-ng/uploads/clients/$client_id");
    }
