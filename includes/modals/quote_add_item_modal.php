    ...
    <div class="modal-dialog">
        <div class="modal-content bg-dark">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fa fa-fw fa-piggy-bank mr-2"></i>Add Quote Item</h5>
            ...
            <input hidden name="quote_id" value="<?=$quote_id?>">
            ...
            <div class="modal-footer bg-white">
                <button type="submit" name="add_quote_item" class="btn btn-label-primary text-bold">Add</button>
