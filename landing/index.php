...
<!-- Website for  Managed Services Provider -->

<html lang="en" class="light-style layout-navbar-fixed layout-wide" dir="ltr" data-theme="theme-default" data-assets-path="/includes/assets/" data-template="front-pages" data-style="light">

<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

    <title>Texas IT Support & Managed IT | TWE Tech</title>
...
<body>
            ...
            <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
                ...
                <div class="navbar-brand app-brand demo d-flex py-0 me-4 me-xl-8">
                    ...
                    <a href="landing-page.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold ms-2 ps-1">TWE Technologies</span>
                    </a>
                </div>
                    ...
                    <ul class="navbar-nav me-auto">
                                ...
                                <div class="row gy-4">
                                    <div class="col-12 col-lg">
                                        ...
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link mega-dropdown-link" href="managed-services.php">
                                                    <i class="bx bx-radio-circle me-1"></i>
                                                    <span data-i18n="Managed Services">Managed Services</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link mega-dropdown-link" href="hourly-it-support.php">
                                                    <i class="bx bx-radio-circle me-1"></i>
                                                    <span data-i18n="Hourly IT Support">Hourly IT Support</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link mega-dropdown-link" href="cyber-security.php">
                                                    <i class="bx bx-radio-circle me-1"></i>
                                                    <span data-i18n="Cyber Security">Cyber Security</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link mega-dropdown-link" href="cloud-and-infrastructure.php">
                                                    <i class="bx bx-radio-circle me-1"></i>
                                                    <span data-i18n="Cloud & Infrastructure">Cloud & Infrastructure</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-12 col-lg">
                                        ...
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link mega-dropdown-link" href="workstations.php">
                                                    <i class="bx bx-radio-circle me-1"></i>
                                                    <span data-i18n="Workstations">Workstations</span>                                                  
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link mega-dropdown-link" href="servers-and-clusters.php">
                                                    <i class="bx bx-radio-circle me-1"></i>
                                                    <span data-i18n="Servers & Clusters">Servers & Clusters</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link mega-dropdown-link" href="networking.php">
                                                    <i class="bx bx-radio-circle me-1"></i>
                                                    <span data-i18n="Networking">Networking</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link mega-dropdown-link" href="storage.php">
                                                    <i class="bx bx-radio-circle me-1"></i>
                                                    <span data-i18n="Storage">Storage</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link mega-dropdown-link" href="software.php">
                                                    <i class="bx bx-radio-circle me-1"></i>
                        ...
                        <li class="nav-item mega-dropdown">
                            ...
                            <div class="dropdown-menu p-4 p-xl-8">
                                <div class="row gy-4">
                                    <div class="col-12 col-lg">
                                        <a href="blog.php" class="nav-link mega-dropdown-link">
                                            <i class="bx bx-radio-circle me-1"></i>
                                            <span data-i18n="Blog">Blog</span>
                                        </a>
                                    </div>
                                    <div class="col-12 col-lg">
                                        <a href="case-studies.php" class="nav-link mega-dropdown-link">
                                            <i class="bx bx-radio-circle me-1"></i>
                                            <span data-i18n="Case Studies">Case Studies</span>
                                        </a>
                                    </div>
                                    <div class="col-12 col-lg">
                                        <a href="whitepapers.php" class="nav-link mega-dropdown-link">
                                            <i class="bx bx-radio-circle me-1"></i>
                                            <span data-i18n="Whitepapers">Whitepapers</span>
                                        </a>
                                    </div>
                                    <div class="col-12 col-lg">
                                        <a href="pricing.php" class="nav-link mega-dropdown-link">
                                            <i class="bx bx-radio-circle me-1"></i>
                ...
                <ul class="navbar-nav flex-row align-items-center ms-auto">
                    <!-- navbar button: Start -->
                    <li>
                        <a href="https://nestogy" class="btn btn-primary" target="_blank"><span class="tf-icons bx bx-log-in-circle scaleX-n1-rtl me-md-1"></span><span class="d-none d-md-block">Login/Register</span></a>
                    </li>
                    <!-- navbar button: End -->
                </ul>
                <!-- Toolbar: End -->
    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
        ...
        <section id="hero-animation">
            <div id="landingHero" class="section-py landing-hero position-relative">
                <img src="/includes/assets/img/front-pages/backgrounds/hero-bg.png" alt="hero background" class="position-absolute top-0 start-50 translate-middle-x object-fit-cover w-100 h-100" data-speed="1" />
                <div class="container">
                    <div class="hero-text-box text-center position-relative">
                        <h1 class="text-primary hero-title display-6 fw-extrabold">
                            We focus on your tech, so you can focus on what's important.
                        </h1>
                        <h2 class="hero-sub-title h6 mb-6">
                            Don't work for your technology;
                        ...
                        <div class="landing-hero-btn d-inline-block position-relative">
                            ...
                            <a href="#landingPricing" class="btn btn-primary btn-lg">Learn More</a>
                        </div>
                    </div>
        ...
        <section id="landingFeatures" class="section-py landing-features">
            <div class="container">
                <div class="text-center mb-4">
                    <span class="badge bg-label-primary">About Us</span>
                </div>
                <h4 class="text-center mb-1">
                    Services to help your business function.
                </h4>
                <p class="text-center mb-12">
                    Not just a set of tools, but a complete solution to help your business grow.
                </p>
                <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="/includes/assets/img/front-pages/icons/laptop.svg" alt="laptop charging" />
                        </div>
                        <h5 class="mb-2">24/7 Support</h5>
                        <p class="features-icon-description">
                            We offer 24/7 support to help you with any issues you may have, no matter the time of day.
                        </p>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="/includes/assets/img/front-pages/icons/rocket.svg" alt="transition up" />
                        </div>
                        <h5 class="mb-2">Fast Response Time</h5>
                        <p class="features-icon-description">
                            We understand that time is money, so we make sure to respond to your issues as quickly as possible.
                        </p>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="/includes/assets/img/front-pages/icons/paper.svg" alt="edit" />
                        </div>
                        <h5 class="mb-2">Custom Solutions</h5>
                        <p class="features-icon-description">
                            We understand that every business is unique, so we offer custom solutions to fit your needs.
                        </p>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="/includes/assets/img/front-pages/icons/check.svg" alt="3d select solid" />
                        </div>
                        <h5 class="mb-2">Quality Service</h5>
                        <p class="features-icon-description">
                            We pride ourselves on providing quality service to all of our customers, just read our testemonials.
                        </p>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="/includes/assets/img/front-pages/icons/user.svg" alt="user" />
                        </div>
                        <h5 class="mb-2">Friendly Staff</h5>
                        <p class="features-icon-description">
                            Our staff is always friendly and ready to help you with any issues you may have.
                        </p>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="/includes/assets/img/front-pages/icons/keyboard.svg" alt="keyboard" />
                        </div>
                        <h5 class="mb-2">Straightforward Pricing</h5>
                        <p class="features-icon-description">
                            We offer straightforward pricing so you know exactly what you're getting and how much it will cost.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6 col-lg-5 col-xl-3">
                        ...
                        <h4 class="mb-1">
                            <span class="position-relative fw-extrabold z-1">What people say
                                <img src="/includes/assets/img/front-pages/icons/section-title-icon.png" alt="laptop charging" class="section-title-img position-absolute object-fit-contain bottom-0 z-n1" />
                            </span>
                        </h4>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-4">
                                                    <img src="" alt="client logo" class="client-logo img-fluid" />
                                                </div>
                                                <p>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="/includes/assets/img/avatars/1.png" alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="/includes/assets/img/avatars/2.png" alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="/includes/assets/img/avatars/3.png" alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="/includes/assets/img/avatars/4.png" alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="/includes/assets/img/avatars/5.png" alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-0">Eugenia Moore</h6>
                                                        <p class="small text-muted mb-0">Founder of Hubspot</p>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-4">
                                                    <img src="/includes/assets/img/front-pages/branding/logo-6.png" alt="client logo" class="client-logo img-fluid" />
                                                </div>
                                                <p>
                    ...
                    <div class="col-lg-6 col-sm-12">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div class="bg-label-primary border border-bottom-0 border-label-primary position-relative team-image-box">
                                <img src="/includes/assets/img/front-pages/landing-page/team-member-1.png" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image" />
                            </div>
                            <div class="card-body border border-top-0 border-label-primary text-center py-5">
                                <h5 class="card-title mb-0">Tad Wachter</h5>
                                <p class="text-muted mb-0">President and Chief Executive Officer</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div class="bg-label-info border border-bottom-0 border-label-info position-relative team-image-box">
                                <img src="/includes/assets/img/front-pages/landing-page/team-member-2.png" class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl" alt="human image" />
                            </div>
                            <div class="card-body border border-top-0 border-label-info text-center py-5">
                                <h5 class="card-title mb-0">Andrew Malsbury</h5>
                                <p class="text-muted mb-0">Chief Operating Officer</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center mb-12">
                    <div class="position-relative d-inline-block pt-3 pt-md-0">
                        ...
                        <div class="pricing-plans-item position-absolute d-flex">
                            <img src="/includes/assets/img/front-pages/icons/pricing-plans-arrow.png" alt="pricing plans arrow" class="scaleX-n1-rtl" />
                            <span class="fw-medium mt-2 ms-1"> Save 5%</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="card border border-primary shadow-none">
                            <div class="card-body text-center">
                                ...
                                <p class="text-muted  mb-4">Estimate the cost of your plan</p>
                            </div>
                            <div class="card-body border-top border-bottom border-primary">
                                <div class="pricing-calculator">
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="pricing-calculator-item">
                                                <label for="pricing-calculator-workstations">Workstations</label>
                                                <input type="number" id="pricing-calculator-workstations" class="form-control" value="1" />
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="pricing-calculator-item">
                                            <label for="pricing-calculator-servers">Servers</label>
                                            <input type="number" id="pricing-calculator-servers" class="form-control" value="1" />
                                        </div>
                                    </div>
            ...
            <div class="container">
                <div class="row gy-6">
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-primary shadow-none">
                            <div class="card-body text-center">
                                <img src="/includes/assets/img/front-pages/icons/laptop.svg" alt="laptop" class="mb-4" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-success shadow-none">
                            <div class="card-body text-center">
                                <img src="/includes/assets/img/front-pages/icons/user-success.svg" alt="laptop" class="mb-4" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-info shadow-none">
                            <div class="card-body text-center">
                                <img src="/includes/assets/img/front-pages/icons/diamond-info.svg" alt="laptop" class="mb-4" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-warning shadow-none">
                            <div class="card-body text-center">
                                <img src="/includes/assets/img/front-pages/icons/check-warning.svg" alt="laptop" class="mb-4" />
        ...
        <section id="landingCTA" class="section-py landing-cta position-relative p-lg-0 pb-0">
            <img src="/includes/assets/img/front-pages/backgrounds/cta-bg-light.png" class="position-absolute bottom-0 end-0 scaleX-n1-rtl h-100 w-100 z-n1" alt="cta image" data-app-light-img="front-pages/backgrounds/cta-bg-light.png" data-app-dark-img="front-pages/backgrounds/cta-bg-dark.png" />
            <div class="container">
                <div class="row align-items-center gy-12">
                    ...
                    <div class="col-lg-6 pt-lg-12 text-center text-lg-end">
                        <img src="/includes/assets/img/front-pages/landing-page/cta-dashboard.png" alt="cta dashboard" class="img-fluid mt-lg-4" />
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row g-6">
                    <div class="col-lg-5">
                        <div class="contact-img-box position-relative border p-2 h-100">
                            <img src="/includes/assets/img/front-pages/icons/contact-border.png" alt="contact border" class="contact-border-img position-absolute d-none d-lg-block scaleX-n1-rtl" />
                            <img src="/includes/assets/img/front-pages/landing-page/contact-customer-service.png" alt="contact customer service" class="contact-img w-100 scaleX-n1-rtl" />
                            <div class="p-4 pb-2">
                                <div class="row g-4">
    ...
    <footer class="landing-footer bg-body footer-text">
        <div class="footer-top position-relative overflow-hidden z-1">
            <img src="/includes/assets/img/front-pages/backgrounds/footer-bg.png" alt="footer bg" class="footer-bg banner-bg-img z-n1" />
            <div class="container">
                <div class="row gx-0 gy-6 g-lg-10">
                    ...
                    <div class="col-lg-3 col-md-4">
                        ...
                        <a href="javascript:void(0);" class="d-block mb-4"><img src="/includes/assets/img/front-pages/landing-page/apple-icon.png" alt="apple icon" /></a>
                        <a href="javascript:void(0);" class="d-block"><img src="/includes/assets/img/front-pages/landing-page/google-play-icon.png" alt="google play icon" /></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
                ...
                <div>
                    <a href="https://github.com/themeselection" class="me-4" target="_blank">
                        <img src="/includes/assets/img/front-pages/icons/github.svg" alt="github icon" />
                    </a>
                    <a href="https://www.facebook.com/ThemeSelections/" class="me-4" target="_blank">
                        <img src="/includes/assets/img/front-pages/icons/facebook.svg" alt="facebook icon" />
                    </a>
                    <a href="https://twitter.com/Theme_Selection" class="me-4" target="_blank">
                        <img src="/includes/assets/img/front-pages/icons/twitter.svg" alt="twitter icon" />
                    </a>
                    <a href="https://www.instagram.com/themeselection/" target="_blank">
                        <img src="/includes/assets/img/front-pages/icons/instagram.svg" alt="google icon" />
                    </a>
                </div>
            </div>
        </div>
