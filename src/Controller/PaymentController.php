...
class PaymentController
{
    ...
    public function handleStep(string $step, array $postData): mixed
    {
        switch ($step) {
     ...
     */
    private function verifyCode(string $code): bool
    {
     ...
     */
    private function savePaymentInfo(array $data): bool
    {
        // Validate amount
    ...
    private function savePaymentMethod(string $method): void
    {
